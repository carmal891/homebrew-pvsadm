class Pvsadm < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/ppc64le-cloud/pvsadm/releases/download/vv0.1.9/pvsadm-darwin-amd64.tar.gz"
      sha256 "7af9d26b61a032f874be6d5a040b762796651bfde1acf95188b23ad85de1a646"
    end

    on_arm do
      url "https://github.com/ppc64le-cloud/pvsadm/releases/download/vv0.1.9/pvsadm-darwin-arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/ppc64le-cloud/pvsadm/releases/download/vv0.1.9/pvsadm-linux-amd64.tar.gz"
